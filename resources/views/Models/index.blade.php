            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <a href="{{route('models.create')}}"  class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Modals </a>
                    </div>
                </div>
                <!--end::Header-->
                <!--begin::Body-->
                                ...
                                @foreach ($models as $model)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button type="submit" onclick="return confirm('Are you sure you want to delete this model')" class="btn btn-sm btn-clean btn-icon"><i class="la la-trash"></i></a>
                                            @csrf
                                            @method('DELETE')
                                            </form>
                                        </td>         
